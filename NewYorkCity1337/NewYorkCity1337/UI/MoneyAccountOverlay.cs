...
namespace NewYorkCity1337.UI
{
    public class MoneyAccountOverlay : IGameObject
    {
        ...
        {
            _panelShadow = new RectangleTexture(254, 34, Color.FromNonPremultiplied(0, 0, 0, 80)).Create();
            _panelBorder = new RectangleTexture(254, 34, Color.Black).Create();
            _panel = new RectangleTexture(250, 30, Color.Gray).Create();
        }
